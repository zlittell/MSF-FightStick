...
//Pin Declarations
#define pinUP 5  //Up on stick is pin 6
#define pinDN 6  //Down on stick is pin 7
#define pinLT 7  //Left on stick is pin 8
#define pinRT 8  //Right on stick is pin 9
#define pinB1 9  //Button 1 is pin 10 (Start of top row and across)
#define pinB2 10  //Button 2 is pin 11
#define pinB3 11  //Button 3 is pin 12
#define pinB4 12  //Button 4 is pin 13
#define pinB5 14  //Button 5 is pin 14 (Start of second row and across)
#define pinB6 15  //Button 6 is pin 15
#define pinB7 16  //Button 7 is pin 16
#define pinB8 17  //Button 8 is pin 17
#define pinST 18  //Start Button is pin 18
#define pinSL 19  //Select Button is pin 19
